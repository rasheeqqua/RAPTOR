...
export class RaptorManagerController {
  ...
  public async getJobs(
    ...
    try {
      return this.raptorManagerService.getJobs(status);
    } catch {
  ...
  public async getPendingJobs(): Promise<{ jobs: JobMetadata[] }> {
    try {
      return this.raptorManagerService.getPendingJobs();
    } catch {
      throw new NotFoundException("Server was unable to find the requested list of pending jobs.");
    }
  }
  ...
  public async getRunningJobs(): Promise<{ jobs: JobMetadata[] }> {
    try {
      return this.raptorManagerService.getRunningJobs();
    } catch {
  ...
  public async getCompletedJobs(): Promise<{ jobs: JobMetadata[] }> {
    try {
      return this.raptorManagerService.getCompletedJobs();
    } catch {
